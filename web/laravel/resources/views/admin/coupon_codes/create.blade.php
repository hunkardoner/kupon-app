    ...
    <div class="container">
        ...
        <form action="{{ route('admin.coupon-codes.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control @error('campaign_url') is-invalid @enderror" id="campaign_url" name="campaign_url" value="{{ old('campaign_url') }}" placeholder="https://example.com/campaign">
                @error('campaign_url')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('max_uses_user') is-invalid @enderror" id="max_uses_user" name="max_uses_user" value="{{ old('max_uses_user') }}">
                    @error('max_uses_user')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
