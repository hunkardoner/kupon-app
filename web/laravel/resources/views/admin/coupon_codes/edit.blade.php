...
@section('content')
        ...
        <form action="{{ route('admin.coupon-codes.update', $couponCode) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('campaign_title') is-invalid @enderror" id="campaign_title" name="campaign_title" value="{{ old('campaign_title', $couponCode->campaign_title) }}" placeholder="Special Offer">
